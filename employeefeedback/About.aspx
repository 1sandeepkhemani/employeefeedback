<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="employeefeedback.About" %>
...
<head runat="server">
    ...
    <title>About Employee Feedback System</title>
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            ...
            <footer class="d-flex flex-wrap justify-content-between align-items-center p-3 my-4 border-top bg-body-tertiary">
