<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="employeefeedback.Dashboard" %>
           ...
           <div class=" bg-light">
            ...
            <asp:GridView ID="gvDashboard" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered border-primary table-striped">
                <Columns>
                    ...
                    <asp:BoundField DataField="AverageRating" HeaderText="Average Rating" DataFormatString="{0:0.00}" >
                    <HeaderStyle CssClass="table-primary" />
                    </asp:BoundField>
                </Columns>
            </asp:GridView>
