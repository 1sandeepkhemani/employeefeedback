<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeDashboard.aspx.cs" Inherits="employeefeedback.EmployeeDashboard" %>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
           ...
           <div class=" bg-light">
            <div class="mt-5 p-1 pt-3">
               ...
               <div class="row">
                    <div class="col-8 ">
                         <h3 class=" text-uppercase">Employees Feedback</h3>
                    </div>

                    <div class="col-4 position-relative">

                        <div class="input-group ">
                            <input class="form-control form-control-sm" type="search" id="searchBox" placeholder="Search" aria-label="Search">
                            <button class="btn btn-outline-primary btn-sm " type="submit" id="btnSearch">Search</button>
                        </div>
                    </div>
             </div>  
           </div>
                        ...
                        <div class="card border-primary">
                            ...
                            <div class="card-body">
                                <h5 class="card-title text-primary">
                                    <asp:HyperLink ID="hlName" runat="server" NavigateUrl='<%# "EmployeeFeedbackDetails.aspx?empId=" + Eval("EmployeeID") %>' CssClass="text-decoration-none text-capitalize">
                                        <%# Eval("Name") %>
                                    </asp:HyperLink>
                                </h5>
                                <p class="card-text"><strong>Role:</strong> <%# Eval("Role") %></p>
                                <p class="card-text"><strong>Total Feedback:</strong> <%# Eval("TotalFeedback") %></p>
                                <p class="card-text"><strong>Average Rating:</strong> <%# Eval("AverageRating", "{0:0.00}") %></p>
                            </div>
                        </div>
                    </div>
                </ItemTemplate>
