                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-12">
                                    <table class="table table-bordered">
                                        <tr>
                                            <td>
                                                <img id="imgPhoto" runat="server" class="img-thumbnail rounded-circle d-block mx-auto" style="width: 150px; height: 150px; object-fit: fill;" />
                                            </td>
                                        </tr>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                     <a id="qrLink" runat="server" class="btn btn-primary" target="_blank">Feedback Form</a>
