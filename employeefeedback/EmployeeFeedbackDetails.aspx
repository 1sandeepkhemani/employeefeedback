<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeFeedbackDetails.aspx.cs" Inherits="employeefeedback.EmployeeFeedbackDetails" %>
    ...
    <asp:GridView ID="gvFeedback" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered border-primary table-striped" OnSelectedIndexChanged="gvFeedback_SelectedIndexChanged">
      <Columns>
        ...
        <asp:BoundField DataField="CustomerName" HeaderText="Customer Name" >
          ...
          <HeaderStyle CssClass="table-primary text-capitalize" />
