                                        ...
                                        <div class="col-lg-3 col-sm-12">
                                            <table class="table table-bordered">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="col">
                                                        <a class="text-muted" href="#" id="qrLinkOpen" runat="server" target="_blank">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-qr-code" viewBox="0 0 16 16" data-bs-toggle="tooltip" data-bs-placement="right" title="Open QR">
                                                                <path d="M2 2h2v2H2z"/>
